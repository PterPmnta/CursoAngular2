    ...
    return {
        ...
        execute: function() {
            PeliculasService = (function () {
                ...
                PeliculasService.prototype.insertPelicula = function (nuevaPelicula) {
                    Promise.resolve(mock_peliculas_1.PELICULAS).then(function (peliculas) { return peliculas.push(nuevaPelicula); });
                };
